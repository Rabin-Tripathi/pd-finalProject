...
<body>
    ...
    <div class="contain-main">
        <div class="box">
            <div>
                <div class="bg">
                    <img width="25%" height="300px" style="object-fit:content; object-position: -100% 50%;"
                        src="/pd-finalProject/images/schedule.png" alt="">
                </div>
                <?php
                if ($viewingSchedules) {
                            ...
                            foreach ($startDates as $startDate) {
                                ...
                                if (($startDate->format('Y-m-d') === $currentDateTime->format('Y-m-d'))) {
                                    ...
                                    foreach ($broadcastList as $broadcast) {
                                        echo "<div style='border: 1px solid rgba(0, 0, 0, 0.2); padding: 12px; border-radius: 6px; max-width: 100%;'>";
                                        ...
                                        echo '<a href="/pd-finalProject/schedule.php?broadcast=' . $broadcast['id'] . '" role="button" style="background-color: #21326d; color: white;padding: 8px 12px; border-radius: 6px;display: inline-block;">View More</a>';
                                        echo "</div>";
                                    }
                                    echo "</div>";
                                    echo '</div>';
